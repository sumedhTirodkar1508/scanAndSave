  ...
  const fetchScannedQRs = async () => {
    ...
    try {
      const response = await axios.get(
        `/api/savior/scanned-qr-codes?userId=${session.user.id}`
      );
      ...
      toast({
        variant: "destructive",
        title: "Error",
        description: t("messages.noScannedQRs"),
      });
    } finally {
      setLoading(false);
    }
                      ...
                      {selectedQR && (
                        <ScrollArea className="h-[600px] w-full rounded-md border p-2">
                          <div className="grid gap-4">
                            ...
                            <div>
                              <strong>
                                {t("dialog.details.victimSurname")}
                              </strong>{" "}
                            ...
                            <div>
                              <strong>
                                {t("dialog.details.victimHeight")}
                              </strong>{" "}
                              {selectedQR.qrCode.victimHeight || "N/A"}
                            </div>
                            <div>
                              <strong>
                                {t("dialog.details.victimWeight")}
                              </strong>{" "}
                            ...
                            <div>
                              <strong>
                                {t("dialog.details.victimTelNumber")}
                              </strong>{" "}
                            ...
                            <div>
                              <strong>
                                {t("dialog.details.victimAddress")}
                              </strong>{" "}
                            ...
                            <div>
                              <strong>
                                {t("dialog.details.victimCountry")}
                              </strong>{" "}
                              {selectedQR.qrCode.victimCountry || "N/A"}
                            </div>
                            <div>
                              <strong>
                                {t("dialog.relativeDetails.title", {
                                  number: 1,
                                })}{" "}
