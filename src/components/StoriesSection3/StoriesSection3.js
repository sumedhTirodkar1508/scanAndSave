          ...
          <div className="col-lg-6 mx-auto">
            <div className="sectionTitle text-center mb-65">
              ...
              <h2 className="sectionTitle__big">
                What Is Our Portfolio In Our Journey
              </h2>
            </div>
          </div>
        </div>
        <div className="row">
          {Stories.slice(6, 9).map((stories, index) => (
            <div className="col-xl-4 col-lg-6 col-md-6" key={index}>
              <div
                className={`portfolioBlock portfolioBlock--style3 position-relative ${
                  activeIndex === index ? "portfolioBlock--active" : ""
                }`}
                onMouseEnter={() => handleMouseEnter(index)}
              >
                <figure className="portfolioBlock__figure">
                  <Image
                    className="portfolioBlock__figure__thumb"
                    src={stories.pImg}
                    alt="Gainioz Portfolio"
                  />
                </figure>
                <div className="portfolioBlock__content">
                  <h2 className="portfolioBlock__heading text-uppercase">
                    <Link
                      onClick={ClickHandler}
                      href={"/story-details/[slug]"}
                      as={`/story-details/${stories.slug}`}
                    >
                      {stories.title}
                    </Link>
                  </h2>
                  <Link
                    ...
                    href={"/story-details/[slug]"}
                    as={`/story-details/${stories.slug}`}
                    className="portfolioBlock__hashLink mb-10"
                  >
                    <span># Donation</span>
                  </Link>
                </div>
