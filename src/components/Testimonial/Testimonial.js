...
import tImg1 from "/public/assets/auth/reviewAuth1.png";
import tImg2 from "/public/assets/auth/reviewAuth2.png";
import tImg3 from "/public/assets/auth/reviewAuth3.png";
import tImg4 from "/public/assets/auth/reviewAuth4.png";
import tImg5 from "/public/assets/auth/reviewAuth5.png";
import shape1 from "/public/assets/shapes/testi-shape1.svg";
import shape2 from "/public/assets/shapes/testi-shape2.svg";
import shape3 from "/public/assets/shapes/testi-shape4.svg";
import man from "/public/assets/man/testi-man1.jpg";
  ...
  return (
    <section className="review pt-110 pb-100 position-relative overflow-hidden cc-slide-wrap3">
      <Image
        src={shape1}
        alt="Gainioz Shape"
        className="review__shape review__shape--one"
      />
      <Image
        src={shape2}
        alt="Gainioz Shape"
        className="review__shape review__shape--two"
      />
          ...
          <div className="col-12">
            <div className="review__box mb-30">
              ...
              <ul className="review__box__images">
                <li>
                  <Image src={tImg2} alt="Gainioz Reviewer" />
                </li>
                <li>
                  <Image src={tImg3} alt="Gainioz Reviewer" />
                </li>
                <li>
                  <Image src={tImg4} alt="Gainioz Reviewer" />
                </li>
                <li>
                  <Image src={tImg5} alt="Gainioz Reviewer" />
                </li>
              </ul>
                    ...
                    {testimonial.map((testimonial, tsm) => (
                      <SwiperSlide key={tsm}>
                        <div className="reviewblock__content">
                          <Image
                            className="reviewblock__author__image"
                          ...
                          <h4 className="reviewblock__qotes">
                            “{testimonial.Des}“
                          </h4>
                          <span className="reviewblock__author__name">
                            {testimonial.Name}
                          </span>
                        </div>
                      </SwiperSlide>
